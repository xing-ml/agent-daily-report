...
QUERIES=(
  ...
  "((AIエンジニア OR LLMエンジニア OR 機械学習 OR AIプロダクトマネージャー) (採用 OR 求人 OR 年収 OR 急募)) OR ((AI 엔지니어 OR LLM 엔지니어 OR 머신러닝 OR AI PM) (채용 OR 연봉 OR 공고 OR 급구))"
  "((\"AI engineer\" OR \"machine learning engineer\") (भारत OR इंडिया OR hiring OR salary)) OR ((\"AI engineer\" OR \"LLM engineer\") (தமிழ் OR India OR hiring OR salary))"
  "((\"ingeniero de IA\" OR \"ingeniero de aprendizaje automático\") (empleo OR contratación OR salario OR urgente)) OR ((\"engenheiro de IA\" OR \"engenheiro de machine learning\") (vaga OR contratação OR salário OR urgente))"
  ...
  "((\"مهندس ذكاء اصطناعي\" OR \"باحث ذكاء اصطناعي\") (وظيفة OR توظيف OR راتب OR عاجل)) OR ((\"مهندس هوش مصنوعی\" OR \"پژوهشگر هوش مصنوعی\") (استخدام OR حقوق OR فوری)) OR ((\"yapay zeka mühendisi\" OR \"makine öğrenmesi mühendisi\") (iş OR işe alım OR maaş OR acil))"
)
